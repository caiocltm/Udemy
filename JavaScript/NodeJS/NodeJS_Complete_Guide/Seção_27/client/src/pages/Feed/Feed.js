...
class Feed extends Component {
	...
	componentDidMount() {
      ...
      data.action === "create" && this.addPost(data.post);
      data.action === "update" && this.updatePost(data.post);
      data.action === "delete" && this.loadPosts();
    });
	}
	...
	updatePost = post => {
		this.setState(prevState => {
			...
			updatedPostIndex > -1 && (updatedPosts[updatedPostIndex] = post);
			return {
				posts: updatedPosts
			};
		});
