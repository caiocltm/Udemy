angular.module('lista-telefonica', [])
    ...
    .controller('listaTelefonicaController', function ($scope) {
        ...
        $scope.titleContatos = "Lista de Contatos";
        $scope.titleForm = "Cadastro de Contatos";
        $scope.titleAddButton = "Adicionar Contato";
        $scope.titleDelButton = "Excluir Contato";
        $scope.contatos = [
            { nome: "Caio César", telefone: "991199683", cor: "red" },
            { nome: "Vitor Calazans", telefone: "9911232090", cor: "blue" },
            { nome: "Marli Lopes", telefone: "991146326", cor: "yellow" }
        ];
        $scope.operadoras = [
